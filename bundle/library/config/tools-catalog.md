...
> Файлы в `${CODEX_PACK_ROOT}/library/tools/` и `${CODEX_PACK_ROOT}/library/scripts/`, пригодные к повторному
...
> Запуск: `python ${CODEX_PACK_ROOT}/library/<папка>/<файл> --help`.
...
- `plugins_gc.py` — plugins_gc.py — сборщик мусора для кэша плагинов Claude Code (${CODEX_PACK_ROOT}/library/plugins, ~2
...
> Раньше он строился из личного ${CODEX_PACK_ROOT}/library: 16 записей вели к файлам, которых в паке
