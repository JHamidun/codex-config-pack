...
See ${CODEX_PACK_ROOT}/library/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ${CODEX_PACK_ROOT}/library/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ${CODEX_PACK_ROOT}/library/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ${CODEX_PACK_ROOT}/library/get-shit-done/templates/discovery.md
...
Use ${CODEX_PACK_ROOT}/library/get-shit-done/templates/discovery.md.
