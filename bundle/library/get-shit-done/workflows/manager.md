...
```bash
INIT=$(node "${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat ${CODEX_PACK_ROOT}/library/get-shit-done/workflows/plan-phase.md
2. Run: node \"${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat ${CODEX_PACK_ROOT}/library/get-shit-done/workflows/execute-phase.md
2. Run: node \"${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs\" init execute-phase {N}
