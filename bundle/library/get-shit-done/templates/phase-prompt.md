...
<!-- For checkpoint task examples and patterns, see @${CODEX_PACK_ROOT}/library/get-shit-done/references/checkpoints.md -->
...
See `${CODEX_PACK_ROOT}/library/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `${CODEX_PACK_ROOT}/library/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `${CODEX_PACK_ROOT}/library/get-shit-done/workflows/verify-phase.md` for verification logic.
