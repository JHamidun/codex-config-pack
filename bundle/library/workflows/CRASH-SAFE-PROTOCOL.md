...
- Progress file: ${CODEX_PACK_ROOT}/library/workflows-progress/<WAVE>/<your-agent-label>.progress.md (create dirs if needed).
...
- После успеха волны: удалить ${CODEX_PACK_ROOT}/library/workflows-progress/<WAVE>/ (мусор не копим).
