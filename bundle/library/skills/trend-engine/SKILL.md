...
python ${CODEX_PACK_ROOT}/library/skills/last30days/scripts/last30days.py "<тема>" \
...
[ -f ${CODEX_PACK_ROOT}/library/.credentials.master.env ] && source ${CODEX_PACK_ROOT}/library/.credentials.master.env
...
| `last30days` skill | Required | `${CODEX_PACK_ROOT}/library/skills/last30days/` | Run manually, skip social sweep |
