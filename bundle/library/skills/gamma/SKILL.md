...
- ⚠️ The `GAMMA_API_KEY` stored in `${CODEX_PACK_ROOT}/library/.credentials.master.env` currently returns
...
python ${CODEX_PACK_ROOT}/library/skills/gamma/scripts/gamma_client.py generate \
...
python ${CODEX_PACK_ROOT}/library/skills/gamma/scripts/gamma_client.py poll <generationId> --wait
```
