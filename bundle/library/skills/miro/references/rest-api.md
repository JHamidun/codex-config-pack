...
> База: `https://api.miro.com`. CLI-обёртка: `python ${CODEX_PACK_ROOT}/library/tools/miro_client.py`.
...
6. Положить в `${CODEX_PACK_ROOT}/library/.credentials.master.env` как `MIRO_ACCESS_TOKEN=...`

Заголовок запроса: `Authorization: Bearer $API_KEY
...
```bash
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py whoami                    # проверить токен
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py boards                    # список досок
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py board <board_id>          # инфо о доске
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py items <board_id> --type sticky_note --all
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py sticky <board_id> --text "Идея" --x 0 --y 0
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py shape <board_id> --shape rectangle --text "Этап"
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py frame <board_id> --title "Спринт 1"
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py connect <board_id> --from <id> --to <id>
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py tags <board_id>
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py bulk <board_id> --file items.json
python ${CODEX_PACK_ROOT}/library/tools/miro_client.py raw GET /v2/boards/<id>/connectors
```
