...
Copy `SKILL.md` to:
```
${CODEX_PACK_ROOT}/library/skills/check-skill-solo/SKILL.md
```
...
- If you prefer headless keys, create `${CODEX_PACK_ROOT}/library/skills/check-skill-solo/.env.local` with
