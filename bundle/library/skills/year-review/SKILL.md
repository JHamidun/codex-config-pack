...
1. **Chat search DB**: `python ${CODEX_PACK_ROOT}/library/tools/search_chats.py` — SQLite FTS5 index of all sessions
2. **Session files**: `${CODEX_PACK_ROOT}/library/projects/*/` — JSONL transcript files
3. **Memory files**: `${CODEX_PACK_ROOT}/library/projects/*/memory/` — accumulated knowledge
