...
**Голос для устных материалов** (спикерноутсы, скрипт): `${CODEX_PACK_ROOT}/library/voice-sample.md`
...
Готовым клиентом `python ${CODEX_PACK_ROOT}/library/tools/gdrive_client.py` (`/gdrive`, хаб —
