...
Phrase-level (full negative parallelism coverage as of recent ban):
```
...
> "businesses need AI to cut costs. adoption is the easy part. transformation is the actual work. here's what we learned running X LinkedIn profiles through your system daily."
>
> **Diff:**
...
- **2026-04-27 V2** — split rules into forensic / strict / aesthetic tiers. Added `--mode` flag. Added forensic-tier patterns from Wikipedia (oaicite tokens, knowledge-cutoff disclaimers, phrasal templates). Expanded negative parallelism coverage to all 6 forms per Author's 2026-04-27 ban.
