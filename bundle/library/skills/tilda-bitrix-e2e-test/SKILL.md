...
Обе строки можно дописать в `${CODEX_PACK_ROOT}/library/.credentials.master.env` (общий файл ключей;
заводится из `${CODEX_PACK_ROOT}/library/templates/.credentials.master.env.example`) — готовых
