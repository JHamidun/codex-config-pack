...
- channel = `'your_channel'` (свой @username канала без собаки); сессия — файл `${CODEX_PACK_ROOT}/library/telegram_session`
...
import sys; sys.path.insert(0, os.path.expanduser('${CODEX_PACK_ROOT}/library/skills/tg-post/scripts'))
