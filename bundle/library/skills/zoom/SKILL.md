...
### Credentials (from ${CODEX_PACK_ROOT}/library/.credentials.master.env)
...
Шаблон файла — `${CODEX_PACK_ROOT}/library/templates/.credentials.master.env.example`, эти три строки в нём уже есть.
