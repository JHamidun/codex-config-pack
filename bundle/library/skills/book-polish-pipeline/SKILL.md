...
Шаблоны `${CODEX_PACK_ROOT}/library/templates/{voice-sample,author-profile}.md` — скопируй и заполни
...
память (`${CODEX_PACK_ROOT}/library/projects/<project-slug>/memory/`), иначе следующая книга начнётся с нуля.
