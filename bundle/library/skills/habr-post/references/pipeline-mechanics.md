...
## Templates (`${CODEX_PACK_ROOT}/library/skills/habr-post/templates/`)
...
python ${CODEX_PACK_ROOT}/library/skills/habr-post/templates/security_scan.py FINAL.md
...
(`${CODEX_PACK_ROOT}/library/skills/article-pipeline/references/stage-*.md`) — он же их и гоняет, спавня
