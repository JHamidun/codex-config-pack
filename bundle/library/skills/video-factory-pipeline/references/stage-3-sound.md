# Стадия 3 — Звукорежиссёр (промпт агента `vf-sound`)

> **Запускается ПАРАЛЛЕЛЬНО со стадией 2 (сценарист), не после стадии 5.** Номер здесь —
> порядок в списке, а не очередь. Карта трека нужна раскадровщику (стадия 4) до того, как
> он начнёт класть кадры на сетку долей.
