...
- During large refactors, remove the symlink (`rm .claude/skills/gstack`) so the
  global install at `${CODEX_PACK_ROOT}/library/skills/gstack/` is used instead
...
1. Push your branch
2. Fetch and reset in the skill directory: `cd ${CODEX_PACK_ROOT}/library/skills/gstack && git fetch origin && git reset --hard origin/main`
