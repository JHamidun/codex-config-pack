...
description: "Промпт-инжиниринг генерации картинок (Nano Banana, gpt-image-2.5, Midjourney, SD) + сюрреализм-пресет «эксперт / Магритт-Дали». Триггеры: «креатив для vk ads», «сюрреализм магритт»."
---
...
> **See Also - Specialized API Skills** (вызывать по имени через Skill tool, это отдельные навыки в `${CODEX_PACK_ROOT}/library/skills/`, а не файлы этой папки):
...
Load reference prompts from: `${CODEX_PACK_ROOT}/library/prompts/image_prompts_reference.json`
