...
`~/.config/higgsfield/credentials.json` — the result of the device-flow OAuth login into your own account. Token format is **not stated** in the CLI documentation; most likely a Bearer JWT sent as `Authorization: Bearer $API_KEY
