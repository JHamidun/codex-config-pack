...
```bash
HF="${CODEX_PACK_ROOT}/library/skills/video-generation/engines/higgsfield/bin/hf"   # вендорский бинарь, ставится отдельно (github.com/higgsfield-ai/cli)
...
# 4) montage (наш) — музыка+сабы+9:16: python ${CODEX_PACK_ROOT}/library/skills/video-editor/...  (ASS-караоке лучше их drawtext)
```
