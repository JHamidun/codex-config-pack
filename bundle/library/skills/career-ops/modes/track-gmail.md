...
```bash
python ${CODEX_PACK_ROOT}/library/tools/gmail_search.py \
...
2026-04-12T14:30:00	Acme AI	Applied	Interviewing	high	user@example.com	Next steps	2026-04-11T10:00:00	18f2a9b...
```
...
- [user@example.com] Company X | VP Product | "Saw your background..." | 2026-04-11
```
