...
Использовать NER (named entity recognition) или простой regex-based whitelist из `${CODEX_PACK_ROOT}/library/skills/career-ops/templates/skill-dictionary.yml`.
