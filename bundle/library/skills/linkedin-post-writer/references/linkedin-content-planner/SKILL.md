...
- **Theme** (optional): e.g., "AI agents shipping in production", "first 6 months of YourProduct"
...
- **3-5 posts per week.** 6+/week triggers cannibalization signal in EnterpriseTool.
