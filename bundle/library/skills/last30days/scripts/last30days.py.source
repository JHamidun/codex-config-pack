...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--github-repo", help="Comma-separated owner/repo for project-mode search (e.g., your-gateway-project/your-gateway-project,paperclipai/paperclip)")
...
def main() -> int:
    ...
    # --your-gateway-project) pass through without argparse hard-exiting.
...
def _main(
    ...
    try:
        ...
        # main topic; remaining entities become the competitor list. пользователя
