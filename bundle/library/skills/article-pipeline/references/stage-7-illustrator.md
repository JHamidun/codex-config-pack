...
Read `${CODEX_PACK_ROOT}/library/skills/nano-banana-pro/SKILL.md` and use its prompt patterns. Default is **photorealistic editorial photography** unless the topic strongly calls for illustration.
