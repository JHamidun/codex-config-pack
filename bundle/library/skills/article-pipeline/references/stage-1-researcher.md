...
### 2. Memory
- `${CODEX_PACK_ROOT}/library/projects/<project>/memory/MEMORY.md` and topic files
...
- `python ${CODEX_PACK_ROOT}/library/tools/tg_client.py read-channel <твой канал>` — source of real voice,
