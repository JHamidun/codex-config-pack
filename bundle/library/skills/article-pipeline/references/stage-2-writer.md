...
3. Read the platform skill file if it is installed:
   ...
   - rbc → `${CODEX_PACK_ROOT}/library/skills/rbc-post/SKILL.md`
   - linkedin → `${CODEX_PACK_ROOT}/library/skills/linkedin-post-writer/SKILL.md`
...
4. Read `${CODEX_PACK_ROOT}/library/voice-sample.md` — образец голоса автора.
