...
- habr → `${CODEX_PACK_ROOT}/library/skills/habr-post/SKILL.md` (инженер-практик, не лектор)
- vc → `${CODEX_PACK_ROOT}/library/skills/vc-post/SKILL.md` (B2C «Личный опыт», тёплый)
- rbc → `${CODEX_PACK_ROOT}/library/skills/rbc-post/SKILL.md` (сдержанный эксперт)
- linkedin → `${CODEX_PACK_ROOT}/library/skills/linkedin-post-writer/SKILL.md` (профессиональный, но живой)
...
```yaml
voice_corpus:
  - ${CODEX_PACK_ROOT}/library/voice-sample.md            # голос автора — главный источник
