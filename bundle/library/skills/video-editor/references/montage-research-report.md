...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/references/silence-removal.md`
```markdown
...
Save to: `${CODEX_PACK_ROOT}/library/skills/video-generation/luts/Kodak2383_D55.cube`

File: `${CODEX_PACK_ROOT}/library/skills/video-generation/references/color-grading.md`
```markdown
...
ffmpeg -i input.mp4 \
  -vf "lut3d=file='${CODEX_PACK_ROOT}/library/skills/video-generation/luts/Kodak2383_D55.cube':interp=tetrahedral" \
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/add_captions.py`
```python
#!/usr/bin/env python3
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/beat_sync_edit.py`
```python
#!/usr/bin/env python3
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/karaoke_captions.py`
```python
#!/usr/bin/env python3
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/reframe_9x16.py`
```python
#!/usr/bin/env python3
...
def yolo_crop(input_file, output_file):
    ...
    import os
    repo = '${CODEX_PACK_ROOT}/library/tools/Autocrop-vertical'  # adjust path
    subprocess.run([
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/speed_ramp.py`
- Contains `build_speed_ramp()` function from Section 3I above.

**P2.5: xfade chain builder reference**

File: `${CODEX_PACK_ROOT}/library/skills/video-editor/references/xfade-transitions.md`
```markdown
...
File: `${CODEX_PACK_ROOT}/library/skills/video-generation/references/remotion-overlays.md`
...
File: `${CODEX_PACK_ROOT}/library/skills/video-generation/scripts/motion_graphics.py`
...
File: `${CODEX_PACK_ROOT}/library/skills/video-generation/references/manim-patterns.md`
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/scripts/scene_detect.py`
```python
...
File: `${CODEX_PACK_ROOT}/library/skills/video-editor/references/sound-design.md`
