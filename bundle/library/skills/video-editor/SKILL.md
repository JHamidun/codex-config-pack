...
```bash
python ${CODEX_PACK_ROOT}/library/skills/video-editor/video_editor.py <command> [args]
```
...
```bash
python ${CODEX_PACK_ROOT}/library/skills/video-editor/video_editor.py process \
  input.mp4 \
  --music \
  --brightness 1.1 \
  --contrast 1.2 \
...
```bash
python ${CODEX_PACK_ROOT}/library/skills/video-editor/video_editor.py trim \
  input.mp4 \
  --start 00:00:10 \
  --end 00:01:30 \
  -o clip.mp4
...
```bash
python ${CODEX_PACK_ROOT}/library/skills/video-editor/video_editor.py probe input.mp4
```
