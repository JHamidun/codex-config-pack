...
- Проверить готовый дамп на невидимку без правки кода: `python ${CODEX_PACK_ROOT}/library/scripts/text_sanitize.py book.txt --scan`
