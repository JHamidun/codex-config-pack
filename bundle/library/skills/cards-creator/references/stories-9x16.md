...
python ${CODEX_PACK_ROOT}/library/skills/cards-creator/scripts/build_story_frames.py
...
python ${CODEX_PACK_ROOT}/library/skills/cards-creator/scripts/post_stories.py list YOUR_CHANNEL

# 3) запостить новые
python ${CODEX_PACK_ROOT}/library/skills/cards-creator/scripts/post_stories.py post YOUR_CHANNEL

# 4) ИСПРАВИТЬ уже висящие кривые (подмена медиа, НЕ тратит квоту):
python ${CODEX_PACK_ROOT}/library/skills/cards-creator/scripts/post_stories.py edit YOUR_CHANNEL 3,4,5,6,7,8,9,10
```
