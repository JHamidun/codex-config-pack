...
**Перед началом прочитай `${CODEX_PACK_ROOT}/library/business-context.md`** (заведи из `${CODEX_PACK_ROOT}/library/templates/business-context.md`, если файла ещё нет) — позиционирование, ядро ценности, длина trial, набор ключевых функций/сценариев, карта воронки. Не дублируй позиционирование и метрики.
...
**Метрики активации:** % регистраций trial, дошедших до активации; время до активации; шаги до активации; активация по когортам/источникам. Считать в своей веб-аналитике (счётчик — раздел «Учёт и аналитика» в `${CODEX_PACK_ROOT}/library/business-context.md`).
