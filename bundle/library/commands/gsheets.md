...
`${CODEX_PACK_ROOT}/library/skills/google-workspace/scripts/gsheets_client.py`.

```bash
python ${CODEX_PACK_ROOT}/library/skills/google-workspace/scripts/gsheets_client.py info <id_или_ссылка>
...
Два пути доступа, оба рабочие: OAuth (`${CODEX_PACK_ROOT}/library/google_oauth_token.json`, скоуп
