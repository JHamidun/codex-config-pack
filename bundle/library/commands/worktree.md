...
**What it does:**
- Creates `your-monorepo-worktrees/` directory (if not exists)
...
3. Create worktree: `git worktree add ../your-monorepo-worktrees/<name> -b feature/<name> <base>`
...
|------|--------|------|--------|
| main (основной) | main | <UPSTREAM_HOME>/code/your-monorepo | Active |
| feature-name | feature/feature-name | .../your-monorepo-worktrees/feature-name | Active |
...
2. Find orphaned dirs in `your-monorepo-worktrees/` not in `git worktree list`
