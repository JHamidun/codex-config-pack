...
1. **Local config file** — check `config/brand-voice.json` in your Claude config dir (личный файл, в пак не входит; шаблон рядом — `${CODEX_PACK_ROOT}/library/config/brand-voice.example.json`)
