...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
