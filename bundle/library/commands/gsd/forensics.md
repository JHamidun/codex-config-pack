...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/forensics.md end-to-end.
</process>
