...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/manager.md end-to-end.
