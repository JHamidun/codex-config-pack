...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/execute-phase.md end-to-end.
