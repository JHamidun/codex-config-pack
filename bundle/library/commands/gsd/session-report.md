...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/session-report.md end-to-end.
</process>
