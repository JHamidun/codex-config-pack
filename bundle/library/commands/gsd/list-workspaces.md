...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/list-workspaces.md
@${CODEX_PACK_ROOT}/library/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
