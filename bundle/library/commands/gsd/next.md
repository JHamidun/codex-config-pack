...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/next.md end-to-end.
</process>
