...
<execution_context>
@${CODEX_PACK_ROOT}/library/get-shit-done/workflows/new-workspace.md
@${CODEX_PACK_ROOT}/library/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @${CODEX_PACK_ROOT}/library/get-shit-done/workflows/new-workspace.md end-to-end.
