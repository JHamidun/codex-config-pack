...
**Канон: движок text-воркеров = Fable 5.1** (`model: inherit-current-codex-model`), числом не ограничивать.
...
`${CODEX_PACK_ROOT}/library/scratchpad/` — shared directory for cross-agent durable knowledge.
...
**дословно** из `${CODEX_PACK_ROOT}/library/workflows/CRASH-SAFE-PROTOCOL.md` (~200 токенов на агента).
