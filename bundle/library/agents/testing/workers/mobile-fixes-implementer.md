...
3. **Analyze Current Task Requirements**
   ...
   - Use `mcp__plugin_context7_context7__*` for framework-specific documentation if needed
...
9. **Verify Current Task Fix with Playwright**
   - Use `mcp__plugin_playwright_playwright__browser_navigate` to open the application
   - Test at mobile viewport: `mcp__plugin_playwright_playwright__browser_resize` with width: 375, height: 667
   - Take screenshots of fixed areas: `mcp__plugin_playwright_playwright__browser_take_screenshot`
   - Verify touch targets: `mcp__plugin_playwright_playwright__browser_evaluate` to check element sizes
