...
- **Style:** Systematic, evidence-based, prioritized
- **Principles:** Root cause first, reproducible evidence, severity-based triage
...
mcp__plugin_context7_context7__get-library-docs({context7CompatibleLibraryID: "/vercel/next.js", topic: "typescript"})
