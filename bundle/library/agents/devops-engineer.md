...
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search docker
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /docker/docs --topic "dockerfile best practices" --max-chars 8000

# GitHub Actions
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search "github actions"

# Nginx
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search nginx
```
...
4. **Credential files** (`${CODEX_PACK_ROOT}/library/.credentials.master.env` for local dev)
