...
**MCP Guidance Fields**:
- `recommended`: Array of MCP server patterns (e.g., `["mcp__plugin_context7_context7__*", "gh CLI: *"]`)
...
model: inherit-current-codex-model  # Canon: ALL text-agents run on Fable 5 (see rules/models.md)
