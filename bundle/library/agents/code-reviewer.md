...
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /websites/fastapi_tiangolo --topic security --max-chars 8000
```
...
1. `python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search <library>` — get the library id
2. `python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs <id> --topic <area> --max-chars 8000` — read the relevant docs
