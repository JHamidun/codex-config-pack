...
Python scripts in `${CODEX_PACK_ROOT}/library/skills/manus-slides/scripts/`:
...
```bash
python ${CODEX_PACK_ROOT}/library/skills/manus-slides/scripts/whiteboard_generator.py recommend "<topic description>"
```
...
```bash
python ${CODEX_PACK_ROOT}/library/skills/manus-slides/scripts/whiteboard_generator.py regenerate slides.json ./generated slide_03
```
