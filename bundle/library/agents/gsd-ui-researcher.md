...
Use template from `${CODEX_PACK_ROOT}/library/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `${CODEX_PACK_ROOT}/library/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
