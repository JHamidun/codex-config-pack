...
Reference full template: `${CODEX_PACK_ROOT}/library/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `${CODEX_PACK_ROOT}/library/get-shit-done/templates/state.md`.
