...
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search react
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search next.js

# Step 2 — fetch docs for the area you are about to touch
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /facebook/react --topic "hooks" --max-chars 8000
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /vercel/next.js --topic "app router" --max-chars 8000
```
