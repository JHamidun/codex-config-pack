...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ${CODEX_PACK_ROOT}/library
                  → checks ${CODEX_PACK_ROOT}/library/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ${CODEX_PACK_ROOT}/library/get-shit-done
                  → writes to ${CODEX_PACK_ROOT}/library/get-shit-done/hooks/
...
```bash
INIT=$(node "${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "${CODEX_PACK_ROOT}/library/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
