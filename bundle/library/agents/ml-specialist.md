...
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search pytorch
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py search transformers

# Step 2 — fetch docs for the area you are about to touch
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /pytorch/pytorch --topic "mixed precision" --max-chars 8000
python ${CODEX_PACK_ROOT}/library/tools/context7_docs.py docs /huggingface/transformers --topic "Trainer" --max-chars 8000
```
